...
**Spring, Spring Boot, JPA, MySQL**를 기반으로 한 **서버 사이드 렌더링** 쇼핑몰 프로젝트. SPRING MVC를 이용하여 JWT를 활용한 인증 및 세션 관리, 상품 관리, 결제 연동 등 다양한 기능을 포함하여 실제 운영 중인 쇼핑몰 시스템의 구조를 예상하여 개발해보았습니다.
...
**1. ElasticSearch의 역색인을 통한 매우 빠른 검색기능을 통해서 상품검색 자동완성 기능을 구현이 가능하였습니다.**
...
**2. 검색 부분에서 매우 빠른 속도 향상을 보여주었습니다.**
...
In절을 통해서 풀스캔할필요 없이 바로 상품들을 가져오게끔 구현했습니다.
