...
public class UpdateDto {
   ...
   private String detailAddress;
    ...
    @Builder
    private UpdateDto (String username, String nickname, String deliveryAddress, String detailAddress) {
    ...
    public static UpdateDto of(String username, String nickname, String deliveryAddress, String detailAddress) {
